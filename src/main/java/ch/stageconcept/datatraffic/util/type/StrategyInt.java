...
public class StrategyInt implements Strategy<DTVFEditDialogIntController, Integer> {
	...
	@Override
	public void setControllerFilterValue(DynTableFilter<?> selectedDynTableFilter, DTVFEditDialogIntController filterController) {
	...
	public DynTableFilter<Integer> createDynTableViewFilter(
			ComboBox<DynTableFilter<?>> columnNameTypeComboBox, DTVFEditDialogIntController filterController) {
